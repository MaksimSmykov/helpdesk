(function () {
  ...
  ITN.KB_ARTICLES = [
    ...
    {
      id: "kb-009",
      title: "Обновление корпоративного Microsoft Edge",
      category: "software",
      summary: "Как проверить версию Edge, установить обновления и убедиться, что портал, CRM и Teams открываются корректно.",
      steps: [
        "Откройте Microsoft Edge и перейдите в меню «…» → «Параметры» → «О программе Microsoft Edge»",
        "Дождитесь автоматической проверки обновлений — Edge скачает их в фоне",
        "Если доступна новая версия, нажмите «Перезапустить», чтобы применить обновление",
        "После перезапуска откройте portal.company.ru и выполните вход через SSO",
        "Проверьте работу CRM и Microsoft Teams — при ошибках очистите кэш браузера или создайте заявку в IT"
      ],
      helpful: 0,
      notHelpful: 0
    },
    {
      id: "kb-010",
      title: "Настройка подписи и правил в Outlook",
      category: "software",
      summary: "Вход в Outlook Web, проверка корпоративной подписи и базовых правил обработки писем.",
      steps: [
        "Откройте outlook.office.com и войдите корпоративной учётной записью",
        "Перейдите в «Параметры» → «Почта» → «Создать ответы» → «Подпись электронной почты»",
        "Убедитесь, что подключена утверждённая корпоративная подпись (ФИО, должность, телефон)",
        "Проверьте раздел «Правила» — удалите устаревшие переадресации, если они больше не нужны",
        "Отправьте себе тестовое письмо из Outlook Web и убедитесь, что подпись отображается корректно"
      ],
      helpful: 0,
      notHelpful: 0
    },
    {
      id: "kb-011",
      title: "Подключение корпоративной почты на телефоне",
      category: "software",
      summary: "Настройка Outlook или встроенного почтового клиента на смартфоне и проверка синхронизации.",
      steps: [
        "Установите Microsoft Outlook из App Store / Google Play (рекомендуемый корпоративный клиент)",
        "Добавьте учётную запись с корпоративным email в формате name@company.ru",
        "Подтвердите вход через SSO и, при запросе, код из Microsoft Authenticator",
        "Включите синхронизацию почты, календаря и контактов в настройках учётной записи",
        "Отправьте тестовое письмо себе с телефона и убедитесь, что оно пришло на ноутбук в течение 1–2 минут"
      ],
      helpful: 0,
      notHelpful: 0
    }
  ...
  ITN.MISSIONS = [
    {
      ...
      steps: [
        { id: "s1", title: "Открыть portal.company.ru/security", done: true, articleId: "kb-003" },
        { id: "s2", title: "Установить Microsoft Authenticator", done: true, articleId: "kb-003" },
        { id: "s3", title: "Привязать аккаунт по QR-коду", done: false, articleId: "kb-003" },
        { id: "s4", title: "Сохранить резервные коды", done: false, articleId: "kb-003" }
      ]
    },
    {
      id: "mission-vpn",
      ...
      steps: [
        { id: "s1", title: "Скачать VPN-клиент с портала", done: true, articleId: "kb-002" },
        { id: "s2", title: "Импортировать профиль company-vpn", done: true, articleId: "kb-002" },
        { id: "s3", title: "Подключиться к vpn1.company.ru", done: true, articleId: "kb-002" },
        { id: "s4", title: "Проверить доступ к intranet", done: false, articleId: "kb-002" }
      ]
    },
    {
      id: "mission-browser",
      ...
      steps: [
        { id: "s1", title: "Открыть настройки браузера", done: true, articleId: "kb-009" },
        { id: "s2", title: "Проверить наличие обновлений", done: true, articleId: "kb-009" },
        { id: "s3", title: "Установить обновление и перезапустить", done: true, articleId: "kb-009" },
        { id: "s4", title: "Проверить вход на portal.company.ru", done: true, articleId: "kb-009" }
      ]
    },
    {
      id: "mission-mail",
      ...
      steps: [
        { id: "s1", title: "Войти в Outlook Web", done: true, articleId: "kb-010" },
        { id: "s2", title: "Проверить правила и подпись", done: true, articleId: "kb-010" },
        { id: "s3", title: "Настроить почту на телефоне", done: false, articleId: "kb-011" },
        { id: "s4", title: "Отправить тестовое письмо себе", done: false, articleId: "kb-011" }
      ]
    }
  ];
  ...
  ITN.DEMO_PROFILE = {
    ...
    devices: [
      ...
      { id: "dev-2", name: "iPhone 14", inventory: "INV-45822", status: "В работе", os: "iOS 18 · Корпоративный", owner: "Иван Петров" },
      { id: "dev-3", name: "Док-станция Lenovo USB-C Dock", inventory: "INV-45823", status: "Подключена", os: "MON-27-014 / MON-27-015", owner: "Рабочее место S-314" }
    ],
